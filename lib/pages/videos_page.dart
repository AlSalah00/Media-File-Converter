    ...
    return Scaffold(
      ...
      body: Center(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              Icon(Icons.play_circle, size: 70, color: AppColors.primary),
              SizedBox(height: 12),
              Text('Convert Video Formats',
              ...
              CustomDropdown(
                ...
                items: ['MP4', 'MOV', 'MKV', 'MPG', 'WEBM', 'OGG'],
                onChanged: (newValue) {
                  setState(() {
              ...
              CustomButton(
                ...
                onPressed: (!isUploading) ? () async {
                  ...
                  PickedFilesResult result = await FilePickerHelper.pickFiles(
                    allowedExtensions: ['mp4', 'mov', 'mkv', 'mpg', 'webm', 'ogg'],
              ...
              Text('Total files size allowed: 100MB.',
                  style: TextStyle(fontSize: 15, color: AppColors.textPrimaryDark)),
