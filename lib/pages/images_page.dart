    ...
    return Scaffold(
      ...
      body: Center(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              Icon(Icons.image, size: 70, color: AppColors.primary),
              SizedBox(height: 12),
              ...
              CustomDropdown(
                ...
                items: ['JPG', 'PNG', 'PSD', 'GIF', 'WEBP', 'BMP'],
                onChanged: (newValue) {
                  setState(() {
              ...
              CustomButton(
                ...
                onPressed: (!isUploading) ? () async {
                  ...
                  PickedFilesResult result = await FilePickerHelper.pickFiles(
                    allowedExtensions: ['jpg', 'png', 'psd', 'gif', 'webp', 'bmp'],
              ...
              Text('Total files size allowed: 10MB.',
                  style: TextStyle(fontSize: 15, color: AppColors.textPrimaryDark)),
